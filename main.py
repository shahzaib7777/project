...
text = ask_user
response = requests.get(api_url + text, headers={'X-Api-Key': '9+Zn4N8BWdJNZfVzeyZ1sQ==ttYN68WkZKGjdW4V'})
...
eggafter_user = input("which other food would you like nutritional information on: ")
